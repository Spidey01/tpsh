...
=item B<test> I<EXPRESSION>

Returns true or false based on the evaluation of I<EXPRESSION>. If
I<EXPRESSION> is ommitted, it behaves exactly like the B<false> built in
command.

The B<test> built in command has it's own conditonal language. See `man test`
or Google for an overview but not that your systems test I<program> may differ
from tpsh's built in version. The operators are listed below:
	...
	EXPR1 -o EXPR2
		either of EXPR1 or EXPR2 are true.

	-n STR
		STR is a non-zero length string.
	...
	NUM1 -eq NUM2
		the numeric value NUM1 is equal to the numeric value NUM2.

	NUM1 -ge NUM2
		the numeric value NUM1 is greater than or equal to the numeric value NUM2.

	NUM1 -gt NUM2
		the numeric value NUM1 is greater than the numeric value NUM2.

	NUM1 -le NUM2
		the numeric value NUM1 is less than or equal to the numeric value NUM2.

	NUM1 -lt NUM2
		the numeric value NUM1 is less than the numeric value NUM2.

	NUM1 -ne NUM2
		the numeric value NUM1 is not equal to the numeric value NUM2.
	...
	-g FILE
		FILE has the setgid bit set.

	-h FILE
		FILE is a symbolic link.

	-k FILE
		FILE has the stickly bit set.

	-L FILE
		Compatability alias for -h.
